    ...
    return Scaffold(
      ...
      body: BlocBuilder<ProductCubit, ProductStates>(
        builder: (context, state) {
          ...
          // if(state is GetUnShippedOrdersSuccessState || state is ChangeOrderStatusSuccessState)
          //   {
          ...
          //                   key: ValueKey(unShippedOrders[index].orderId), // Use a unique key based on the order ID
